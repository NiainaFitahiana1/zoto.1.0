...
<nav>
  <ol class="flex items-center gap-2">
    ...
    <li class="font-bold font-mono text-red-600 py-1 px-2">Création Article</li>
  </ol>
</nav>
</div>
<!-- Breadcrumb End -->
          ...
          <div class="mt-1">
            ...
            <form action={{route("phase1")}} method="POST" enctype="multipart/form-data">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <!-- Form Group -->
                  <div>
                    <label for="type_id" class="block text-sm mb-2 dark:text-gray-800">Service</label>
                    <div class="relative">
                      <select 
                      name="type_id" 
                      class="py-3 px-4 block w-full border-gray-600 bg-gray-50 rounded-md text-sm focus:outline-none dark:text-gray-800 dark:border-black border"
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    id="photo" 
                    name="photo" 
                    class="file:py-3 block w-full border-gray-600 bg-gray-50 rounded-md text-sm focus:outline-none dark:text-gray-800 dark:border-black border"
